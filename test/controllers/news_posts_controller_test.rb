...
class NewsPostsControllerTest < ActionController::TestCase
  ...
  test "should create news_post" do
    assert_difference('NewsPost.count') do
      post :create, news_post: { content: @news_post.content, location_id: @news_post.location_id, title: @news_post.title }
    end
  ...
  test "should update news_post" do
    patch :update, id: @news_post, news_post: { content: @news_post.content, location_id: @news_post.location_id, title: @news_post.title }
    assert_redirected_to news_post_path(assigns(:news_post))
  end
