...
class SheltersControllerTest < ActionController::TestCase
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post :create, shelter: { description: @shelter.description, location_id: @shelter.location_id, name: @shelter.name, phone: @shelter.phone }
    end
  ...
  test "should update shelter" do
    patch :update, id: @shelter, shelter: { description: @shelter.description, location_id: @shelter.location_id, name: @shelter.name, phone: @shelter.phone }
    assert_redirected_to shelter_path(assigns(:shelter))
  end
